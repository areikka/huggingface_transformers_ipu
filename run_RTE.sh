...
export POPLAR_ENGINE_OPTIONS='{"debug.allowOutOfMemory": "true", "autoReport.outputSerializedGraph": "false", "debug.outputAllSymbols": "true", "autoReport.all": "true","autoReport.directory":"./profiles/test","profiler.perExecutionStreamCopyCycles":"true"}'
